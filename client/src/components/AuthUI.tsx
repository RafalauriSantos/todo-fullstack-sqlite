...
/**
 * ✅ SoC - Container para páginas de autenticação
 * Substitui authStyles.container inline styles por Tailwind
 */
...
/**
 * ✅ SoC - Card Glassmorphism
 * Substitui authStyles.glassCard inline styles
 */
...
/**
 * ✅ SoC - Cabeçalho de marca
 * Substitui authStyles.brandContainer/brandTitle/brandSubtitle
 */
...
export function PrimaryButton({
	...
	return (
		<button
			type={type}
			onClick={onClick}
			className="w-full py-4 border-none rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 text-white text-lg font-bold cursor-pointer shadow-[0_4px_15px_rgba(59,130,246,0.4)] transition-all duration-200 hover:scale-105 hover:shadow-[0_6px_20px_rgba(59,130,246,0.6)]">
			{children}
		</button>
	);
}
